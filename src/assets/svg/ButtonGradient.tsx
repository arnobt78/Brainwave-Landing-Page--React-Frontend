/**
 * Global gradient definitions for Button SVG (btn-left, btn-top, btn-bottom, btn-right).
 * Must be rendered once in the tree (e.g. in App) so buttons can reference them.
 */
