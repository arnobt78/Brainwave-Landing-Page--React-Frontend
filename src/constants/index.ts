/**
 * Central data for the landing page: nav items, hero icons, pricing, roadmap, benefits, socials.
 * Editing this file updates content across Header, Hero, Pricing, Roadmap, Benefits, Footer, etc.
 */
import {
  benefitIcon1,
  benefitIcon2,
